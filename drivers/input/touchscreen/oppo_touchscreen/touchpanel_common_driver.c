...
static void init_parse_dts(struct device *dev, struct touchpanel_data *ts)
{
    ...
    int temp_array[8];
    //int tx_rx_num[2]; modify end by zhangningjing@ODM_CM@BSP.TP, remove invalid dts 2020-02-20
    int val = 0;
...
/*modify begin by zhangningjing@ODM_CM@BSP.TP, remove invalid dts 2020-02-20*/
#if 0
    // tp type gpio
...
#endif
/*modify end by zhangningjing@ODM_CM@BSP.TP, remove invalid dts 2020-02-20*/
...
/* modify begin by zhangningjing@ODM_CM@BSP.TP, remove invalid charger_pump_support 2020-02-20 */
#if 0
...
#endif
/* modify end by zhangningjing@ODM_CM@BSP.TP, remove invalid charger_pump_support 2020-02-20 */
